...
export const useAboutUsContentsStore = create<AboutUsContentsState>((set) => ({
	hero: {
		...
		text: {
			category: 'ABOUT US',
			heading: 'We Revolutionise Industry With Data & Technology',
			subheading:
				'우리는 기술과 데이터로 다양한 산업 시장들을 혁신하고 있습니다.',
			body: {
				heading:
					'1104 R&I는 첨단 기술과 데이터 과학을 접목하여 다양한 산업 분야에 혁신을 가져오는 것을 목표로 하는 기업입니다. 우리는 각 분야의 전문가들과 협력하여 빅데이터 분석 및 시각화 솔루션을 개발하고 보급하였으며, 이제는 AI와 머신러닝을 활용한 더 높은 수준의 데이터 혁신을 향해 나아가고 있습니다.',
				paragraph: [
					{
						heading:
							'1104 R&I는 고객들에게 데이터에 대한 명확한 이해, 고차원적인 통찰력, 그리고 개별 비즈니스에 최적화된 데이터 전략 개발에 도움을 주는 것을 목표로 합니다.',
						text: '우리는 최신 기술과 응용 수학을 활용하여 획기적인 데이터 분석 및 시각화 시스템을 만들고자 노력하고 있으며, 빅데이터, 인공지능, 기계학습 등의 첨단 기술을 다양한 산업 분야에 접목하여 보다 정교하고 효과적인 의사결정 지원 시스템을 개발하고 있습니다. 이를 통해 우리는 고객들에게 더 나은 비즈니스 성과와 리스크 관리를 제공할 수 있을 것으로 기대합니다.',
					},
					{
						heading:
							'1104 R&I는 복잡하고 빠르게 변화하는 비즈니스 환경에서 고객들에게 명확한 길잡이가 되고자 합니다.',
						text: '우리는 데이터 과학자이자 비즈니스 전문가로서 우리가 알고 있는 것을 진실된 마음으로 공유하고자 하며, 고객을 현혹하거나 오도하지 않겠습니다. 그리고 우리는 데이터에 대한 깊은 이해와 기술적 전문성을 바탕으로 고객들에게 진정으로 도움이 되는 솔루션을 제공할 것이며, 앞으로도 끊임없는 연구와 혁신을 통해 데이터 기반 의사결정의 발전에 기여하고, 고객들의 신뢰할 수 있는 파트너가 될 수 있도록 최선을 다하겠습니다.',
					},
				],
			},
		},
